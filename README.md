...
1567 pass, 3 skip. The suite needs only `pyyaml`, `pytest`, `pandas`,
...
| 8 | `08_figures_for_report` | eleven 300 dpi report figures, colour-vision verification, generated methods and limitations, data provenance | 🟡 written — **awaiting Colab run** |
